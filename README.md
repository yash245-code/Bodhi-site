...
- **Direct Download Matrix & Dedicated Download Center**:
  ...
  - Standalone Portable Archive (`Bodhi Code Editor 1.0.0-beta.1 Windows (ZIP).zip`)
  - Portable Single Executable (`Bodhi Code Editor 1.0.0-beta.1 Portable.exe`)
...
You can open `index.html` directly in any web browser, or serve it using Python or Vite:
...
This landing page has zero build dependencies and can be instantly deployed to:
- **GitHub Pages** (Settings > Pages > Branch: `main` / `root`)
- **Vercel** / **Netlify** / **Cloudflare Pages**

---

&copy; 2026 BUIMB Research. Developed with ❤️ by [Yash.dev](https://github.com/yash245-code).
